const fi = (function() {
  return {
    ...
    each: function(collection, iteratorFunction) {
      const newCollection = (collection instanceof Array) ? collection.slice() : Object.values(collection)

      for (let i = 0; i < newCollection.length; i++) {
        iteratorFunction(newCollection[i])
      }
      return collection
    },

    map: function(collection, iteratorFunction) {
      ...
      for (let i = 0; i < collection.length; i++)
        newArray.push(iteratorFunction(collection[i]))
